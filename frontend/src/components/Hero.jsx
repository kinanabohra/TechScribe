  ...
  return (
    <div className='px-4 md:px-0 '>
      <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:my-0'>
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-4 ">Discover the Future of Tech & Web Innovation</h1>
        <p className="text-lg md:text-xl opacity-80 mb-6 ">
          Dive into expert articles, hands-on tutorials, and fresh insights on web development, digital strategy, and the latest tech trends.        </p>
