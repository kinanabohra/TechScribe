  ...
  return (
    <footer className='bg-gray-800 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            <Link to='/' className='flex gap-3 items-center'>
              ...
              <h1 className=' text-3xl font-bold'>TechScribe</h1>
            </Link>
            ...
            <p className='text-sm'>Email: kinanabohra@gmail.com</p>
            <p className='text-sm'>Phone: 8529482153</p>
        </div>
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()} <span className='text-red-500'>TechScribe</span>. All rights reserved</p>
      </div>
    </footer>
  )
}
